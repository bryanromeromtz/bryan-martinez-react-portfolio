...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://sautsky.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post"
    };
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://sautsky.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id
          }`,
        apiAction: "patch"
      });
    }
          ...
          {this.props.editMode && this.props.blog.featured_image_url ? (
            <div className="manager-image-wrapper">
              ...
              <div className="image-removal-link">
                <a className="btn-removal-link" onClick={() => this.deleteImage("featured_image")}>
                  <span id="span1"></span>
                  <span id="span2"></span>
                  <span id="span3"></span>
                  <span id="span4"></span>
