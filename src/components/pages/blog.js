...
class Blog extends Component {
  ...
  getBlogItems() {
    ...
    axios.
      get(`https://sautsky.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`,
        { withCredentials: true })
      .then(response => {
        this.setState({
  ...
  componentWillUnmount() {
    ...
    document.body.classList.remove("body-blog-color-change");
  }

  componentDidMount() {
    document.body.classList.add("body-blog-color-change");
  }
      ...
      if (this.props.loggedInStatus === "LOGGED_IN") {
        return (
          <div key={blogItem.id} className="admin-blog-wrapper">
            ...
            <button onClick={() => this.handleDeleteClick(blogItem)}>
              <span className="icon">
